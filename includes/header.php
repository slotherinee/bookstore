   ...
   <body class="min-h-screen flex flex-col justify-between">
       <header id="header" class="bg-white dark:bg-gray-800 h-16 transition-all duration-300 ease-in-out z-50">
                       ...
                       <?php foreach ($headerLinks as $title => $link): ?>
                           <?php if (shouldShowLink($title)): ?>
                               <li>
                                   <a
                                       href="<?= $link ?>"
                                       class="text-gray-600 hover:underline underline-offset-4 dark:text-gray-300 <?= $_SERVER["REQUEST_URI"] === $link
